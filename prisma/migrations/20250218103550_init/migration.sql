...
CREATE TABLE "CharacterQuota" (
    ...
    "usedCharacters" INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE "CharacterQuota" ADD CONSTRAINT "CharacterQuota_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
